...
#define GPIO_LCD_VSYNC  (GPIO_NUM_40)
#define GPIO_LCD_HSYNC  (GPIO_NUM_41)
#define GPIO_LCD_PCLK   (GPIO_NUM_38)
...
#define GPIO_LCD_B0    (GPIO_NUM_42)
...
static uint32_t lcdc_width  = 480;
static uint32_t lcdc_height = 480;
